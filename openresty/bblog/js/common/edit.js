    ...
    var edit = {
        ...
        layEditor: function(options){
            var html = '<div class="fly-edit">'
                ...
                +'<span type="href" title="超链接格式：a(href)[text]"><i class="layui-icon">&#xe64c;</i>链接</span>'
                +'<span type="code" title="插入代码"><i class="layui-icon">&#xe635;</i>代码</span>'
                +'<span type="preview" title="预览"><i class="layui-icon">&#xe638;</i>预览</span>'
                +'</div>';
            var log = {}, mod = {
                ...
                ,href: function(editor){ //超链接
                    layer.prompt({
                        ...
                        if(!/^http(s*):\/\/[\S]/.test(val)){
                            layer.tips('骗我，这根本不是链接', elem, {tips:1})
                            return;
                        }
