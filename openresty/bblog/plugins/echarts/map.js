...
function(e) {
    function t(e, t, n, a, o) {
        ...
        this._curMapType,
        this.refresh(a),
        this.zr.on(c.EVENT.MOUSEWHEEL, this._onmousewheel),
        this.zr.on(c.EVENT.MOUSEDOWN, this._onmousedown),
        t.bind(U.EVENT.ROAMCONTROLLER, this._onroamcontroller),
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            this.selectedMap = {},
            this._activeMapType = {};
            for (var t, i, n, a, o = this.component.legend,
            r = {},
            s = {},
            l = {},
            h = {},
            m = 0,
            V = e.length; V > m; m++) if (e[m].type == U.CHART_TYPE_MAP && (e[m] = this.reformOption(e[m]), i = e[m].mapType, s[i] = s[i] || {},
            s[i][m] = !0, l[i] = l[i] || e[m].mapValuePrecision, this._scaleLimitMap[i] = this._scaleLimitMap[i] || {},
            e[m].scaleLimit && p.merge(this._scaleLimitMap[i], e[m].scaleLimit, !0), this._roamMap[i] = e[m].roam || this._roamMap[i], (null == this._hoverLinkMap[i] || this._hoverLinkMap[i]) && (this._hoverLinkMap[i] = e[m].dataRangeHoverLink), this._nameMap[i] = this._nameMap[i] || {},
            e[m].nameMap && p.merge(this._nameMap[i], e[m].nameMap, !0), this._activeMapType[i] = !0, e[m].textFixed && p.merge(g, e[m].textFixed, !0), e[m].geoCoord && p.merge(b, e[m].geoCoord, !0), this._selectedMode[i] = this._selectedMode[i] || e[m].selectedMode, (null == this._hoverable[i] || this._hoverable[i]) && (this._hoverable[i] = e[m].hoverable), (null == this._clickable[i] || this._clickable[i]) && (this._clickable[i] = e[m].clickable), (null == this._showLegendSymbol[i] || this._showLegendSymbol[i]) && (this._showLegendSymbol[i] = e[m].showLegendSymbol), h[i] = h[i] || e[m].mapValueCalculation, t = e[m].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                r[i] = r[i] || {},
                n = e[m].data;
                for (var d = 0,
                c = n.length; c > d; d++) {
                    a = this._nameChange(i, n[d].name),
                    r[i][a] = r[i][a] || {
                        seriesIndex: [],
                        valueMap: {},
                        precision: 0
            ...
            for (var f in r) {
                ...
                this._mapDataMap[f].mapData ? this._mapDataCallback(f, r[f], s[f])(this._mapDataMap[f].mapData) : y[f.replace(/\|.*/, "")].getGeoJson && (this._specialArea[f] = y[f.replace(/\|.*/, "")].specialArea || this._specialArea[f], y[f.replace(/\|.*/, "")].getGeoJson(this._mapDataCallback(f, r[f], s[f])))
            }
        },
        ...
        _getSubMapData: function(e, t) {
            for (var i = e.replace(/^.*\|/, ""), n = t.features, a = 0, o = n.length; o > a; a++) if (n[a].properties && n[a].properties.name == i) {
                n = n[a],
                "United States of America" == i && n.geometry.coordinates.length > 1 && (n = {
                    geometry: {
        ...
        _getProjectionData: function(e, t, i) {
            ...
            n.left != l.left || n.top != l.top || n.scale.x != l.scale.x || n.scale.y != l.scale.y ? (s = a.geoJson2Path(t, n, this._specialArea[e]), l = p.clone(n)) : (n = this._mapDataMap[e].transform, s = this._mapDataMap[e].pathArray),
            this._mapDataMap[e].bbox = r,
            this._mapDataMap[e].transform = n,
            ...
            if ("china" == e) {
                ...
                c = n.scale.x / 10.5,
                u = [32 * c + d[0], 83 * c + d[1]];
                g["南海诸岛"] && (u[0] += g["南海诸岛"][0], u[1] += g["南海诸岛"][1]),
                o.push({
        ...
        _getSingleProvince: function(e, t, i) {
            ...
            if (b[a]) n = this.geo2pos(e, b[a]);
                ...
                n = this.geo2pos(e, [r.left + r.width / 2, r.top + r.height / 2]),
                n[0] += o[0],
                n[1] += o[1]
            }
        ...
        _getTransform: function(e, t, i) {
            ...
            for (var p in t) n = m[p].mapLocation || {},
            o = n.x || o,
            s = n.y || s,
            l = n.width || l,
            h = n.height || h;
        ...
        _buildMap: function(e, t, i, m) {
            for (var V, c, u, y, g, b, f, k, _, x, L, W = this.series,
            ...
            w = t.length; w > K; K++) {
                ...
                c = k.name, u = i[c]) {
                    ...
                    V = "";
                    for (var I = 0,
                    J = u.seriesIndex.length; J > I; I++) {
                        var C = W[u.seriesIndex[I]];
                        g.push(C),
                        V += C.name + " ",
                        X && this._showLegendSymbol[e] && X.hasColor(C.name) && this.shapeList.push(new o({
                            zlevel: C.zlevel,
                            z: C.z + 1,
                            position: p.clone(k.position),
                            _mapType: e,
                ...
                default:
                    x = new a(x),
                    x.buildPathArray && (x.style.pathArray = x.buildPathArray(x.style.path))
                } (this._selectedMode[e] && this._selected[c] && u.selected !== !1 || u.selected === !0) && (L.style = L.highlightStyle, x.style = x.highlightStyle),
                L.clickable = x.clickable = this._clickable[e] && (null == u.clickable || u.clickable),
                this._selectedMode[e] && (this._selected[c] = null != this._selected[c] ? this._selected[c] : u.selected, this._mapTypeMap[c] = e, (null == u.selectable || u.selectable) && (x.clickable = L.clickable = !0, x.onclick = L.onclick = this.shapeHandler.onclick)),
                this._hoverable[e] && (null == u.hoverable || u.hoverable) ? (L.hoverable = x.hoverable = !0, x.hoverConnect = L.id, L.hoverConnect = x.id) : L.hoverable = x.hoverable = !1,
                d.pack(L, {
                    name: V,
        ...
        _buildMark: function(e, t) {
            ...
            "none" == e && (i = [0, 0]);
            for (var n in t) this._seriesIndexToMapType[n] = e,
            this.markAttachStyle[n] = {
                position: i,
                _mapType: e
            },
            this.buildMark(n)
        ...
        _buildHeatmap: function(e) {
            ...
            i = 0,
            n = t.length; n > i; i++) if (t[i].heatmap) {
                ...
                if (t[i].heatmap.needsTransform === !1) {
                    ...
                    if (void 0 === h) {
                        ...
                        for (var r = 0,
                        s = a.length; s > r; ++r) t[i].heatmap._geoData[r] = a[r];
                        h = t[i].heatmap._geoData
                    }
                    for (var s = a.length,
                    U = 0; s > U; ++U) a[U] = this.geo2pos(e, [h[U][0], h[U][1]]);
        ...
        __onmousewheel: function(e) {
            ...
            if (! (this.shapeList.length <= 0)) {
                ...
                d = e.mapTypeControl;
                d || (d = {},
                s = this._findMapTypeByPos(h, m), s && this._roamMap[s] && "move" != this._roamMap[s] && (d[s] = !0));
                var p = !1;
                for (s in d) if (d[s]) {
                    p = !0;
                    ...
                    this._mapDataMap[s].transform = c,
                    k = this.geo2pos(s, k),
                    c.left -= k[0] - (h - y),
                    c.top -= k[1] - (m - g),
                    this._mapDataMap[s].transform = c,
                    ...
                    a = this.shapeList.length; a > n; n++) {
                        ...
                        if (o._mapType == s) {
                            ...
                            case "image":
                                ...
                                x.x = x._x = k[0] - x.width / 2,
                                x.y = x._y = k[1] - x.height / 2;
                                break;
                            default:
                                k = this.geo2pos(s, o._geo),
                                x.x = k[0],
                                x.y = k[1],
                                "text" == _ && (o._style.x = o.highlightStyle.x = k[0], o._style.y = o.highlightStyle.y = k[1])
                            }
            ...
            if (! (this.shapeList.length <= 0)) {
                ...
                if (!t || !t.draggable) {
                    ...
                    if (o && this._roamMap[o] && "scale" != this._roamMap[o]) {
                        ...
                        this._my = a,
                        this._curMapType = o,
                        this.zr.on(c.EVENT.MOUSEUP, this._onmouseup);
                        var r = this;
                        setTimeout(function() {
        ...
        __onmouseup: function(e) {
            ...
            setTimeout(function() {
                ...
                i._justMove = !1,
                i.zr.un(c.EVENT.MOUSEMOVE, i._onmousemove),
                i.zr.un(c.EVENT.MOUSEUP, i._onmouseup)
            },
            120)
        },
        __onroamcontroller: function(e) {
            ...
            i[s] && this._activeMapType[s] && (r = this._mapDataMap[s].transform, this.shapeList[l].position[0] = r.left, this.shapeList[l].position[1] = r.top, this.zr.modShape(this.shapeList[l].id));
            this.messageCenter.dispatch(U.EVENT.MAP_ROAM, e.event, {
                type: "move"
            },
            this.myChart),
        ...
        __ondrhoverlink: function(e) {
            for (var t, i, n = 0,
            a = this.shapeList.length; a > n; n++) t = this.shapeList[n]._mapType,
            this._hoverLinkMap[t] && this._activeMapType[t] && (i = d.get(this.shapeList[n], "value"), null != i && i >= e.valueMin && i <= e.valueMax && this.zr.addHoverShape(this.shapeList[n]))
        },
        onclick: function(e) {
        ...
        getGeoByPos: function(e, t) {
            ...
            var i = [this._mapDataMap[e].transform.left, this._mapDataMap[e].transform.top];
            return t instanceof Array ? (t[0] -= i[0], t[1] -= i[1]) : (t.x -= i[0], t.y -= i[1]),
            this.pos2geo(e, t)
        },
        ...
        getPosByGeo: function(e, t) {
            ...
            return i[0] += this._mapDataMap[e].transform.left,
            i[1] += this._mapDataMap[e].transform.top,
            i
        },
        ...
        onbeforDispose: function() {
            this._isAlive = !1,
            this.zr.un(c.EVENT.MOUSEWHEEL, this._onmousewheel),
            this.zr.un(c.EVENT.MOUSEDOWN, this._onmousedown),
            this.messageCenter.unbind(U.EVENT.ROAMCONTROLLER, this._onroamcontroller),
            this.messageCenter.unbind(U.EVENT.DATA_RANGE_HOVERLINK, this._ondrhoverlink)
        }
    },
    p.inherits(t, i),
...
function(e) {
    ...
    return s.prototype = {
            ...
            for (r = 1; r < s.length; r++) {
                ...
                for (; d.length > 0 && !isNaN(d[0]);) {
                    ...
                    case "A":
                        ...
                        m = d.shift(),
                        x = "A",
                        L = this._convertPoint(W, X, h, m, k, _, g, b, f);
                        break;
                    case "a":
                        g = d.shift(),
                        b = d.shift(),
        ...
        getRect: function(e) {
            ...
            r = e.x || 0,
            s = e.y || 0,
            l = e.pathArray || this.buildPathArray(e.path), h = 0; h < l.length; h++) for (var m = l[h].points, V = 0; V < m.length; V++) V % 2 === 0 ? (m[V] + r < i && (i = m[V]), m[V] + r > n && (n = m[V])) : (m[V] + s < a && (a = m[V]), m[V] + s > o && (o = m[V]));
            var U;
...
function(e) {
    ...
    return i.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            l = r * i;
            e.moveTo(n - o, a),
            e.bezierCurveTo(n - o, a - l, n - s, a - r, n, a - r),
            e.bezierCurveTo(n + s, a - r, n + o, a - l, n + o, a),
            e.bezierCurveTo(n + o, a + l, n + s, a + r, n, a + r),
            e.bezierCurveTo(n - s, a + r, n - o, a + l, n - o, a),
            e.closePath()
        },
...
function(e) {
    ...
    return t.prototype = {
        ...
        _textGap: 10,
        _buildShape: function() {
            if (this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), this._isContinuity() ? this._buildGradient() : this._buildItem(), this.dataRangeOption.show) for (var e = 0,
        ...
        _buildItem: function() {
            ...
            "vertical" == this.dataRangeOption.orient && "right" == this.dataRangeOption.x && (i.style.x -= U + 10, i.style.textAlign = "right"), i._idx = y, i.onmousemove = this._dispatchHoverLink, this.dataRangeOption.selectedMode && (i.clickable = !0, i.onclick = this._dataRangeSelected), this.shapeList.push(new n(i))),
            "horizontal" == this.dataRangeOption.orient ? m += U + (u ? 5 : 0) + (u ? h.getTextWidth(e, l) : 0) + p: V += d + p; ! u && this.dataRangeOption.text[1] && ("horizontal" == this.dataRangeOption.orient ? m = m - p + this._textGap: V = V - p + this._textGap, i = this._getTextShape(m, V, this.dataRangeOption.text[1]), "horizontal" != this.dataRangeOption.orient && (i.style.y -= 5, i.style.textBaseline = "top"), this.shapeList.push(new n(i)))
        },
        _buildGradient: function() {
            ...
            !d && this.dataRangeOption.text[1] && (i = this._getTextShape(r, s, this.dataRangeOption.text[1]), this.shapeList.push(new n(i)));
        ...
        _buildIndicator: function() {
            ...
            s = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[i, n + r], [i - s, n + r + s], [i + s, n + r + s]], t = "bottom") : (e = [[i, n], [i - s, n - s], [i + s, n - s]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[i + a, n], [i + a + s, n - s], [i + a + s, n + s]], t = "right") : (e = [[i, n], [i - s, n - s], [i - s, n + s]], t = "left"),
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" == this.dataRangeOption.orient) {
                ...
                var U;
                if (this.dataRangeOption.text || this._isContinuity()) r = (this._isContinuity() ? a * m + i: t * (a + i)) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[0] ? this._textGap + l: 0) + (this.dataRangeOption.text && "undefined" != typeof this.dataRangeOption.text[1] ? this._textGap + l: 0),
        ...
        __ondrift: function(e, t, i) {
            ...
            r = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? e.style.x + t <= n ? e.style.x = n: e.style.x + t + e.style.width >= n + o ? e.style.x = n + o - e.style.width: e.style.x += t: e.style.y + i <= a ? e.style.y = a: e.style.y + i + e.style.height >= a + r ? e.style.y = a + r - e.style.height: e.style.y += i,
        ...
        _syncShapeFromRange: function() {
            ...
            if (t > i && (t = [i, i = t][0]), this._range.end = null != t ? t: null != this._range.end ? this._range.end: 0, this._range.start = null != i ? i: null != this._range.start ? this._range.start: 100, 100 != this._range.start || 0 !== this._range.end) {
                if ("horizontal" == this.dataRangeOption.orient) {
                    ...
                    this._fillerShape.style.x += n * (100 - this._range.start) / 100,
                    this._fillerShape.style.width = n * (this._range.start - this._range.end) / 100
                } else {
                    var a = this._fillerShape.style.height;
                    this._fillerShape.style.y += a * (100 - this._range.start) / 100,
                    this._fillerShape.style.height = a * (this._range.start - this._range.end) / 100
                }
        ...
        __dataRangeSelected: function(e) {
            ...
            var n, a;
            this._useCustomizedSplit() ? (n = this._splitList[i].max, a = this._splitList[i].min) : (n = (this._colorList.length - i) * this._gap + this.dataRangeOption.min, a = n - this._gap),
        ...
        __dispatchHoverLink: function(e) {
            ...
            if (this.dataRangeOption.calculable) {
                ...
                n = "horizontal" == this.dataRangeOption.orient ? (1 - (l.getX(e.event) - this._calculableLocation.x) / this._calculableLocation.width) * a: (1 - (l.getY(e.event) - this._calculableLocation.y) / this._calculableLocation.height) * a,
                t = n - .05 * a,
                i = n + .05 * a
            } else if (this._useCustomizedSplit()) {
                var o = e.target._idx;
                i = this._splitList[o].max,
                t = this._splitList[o].min
            } else {
                var o = e.target._idx;
                i = (this._colorList.length - o) * this._gap + this.dataRangeOption.min,
                t = i - this._gap
            }
        ...
        __onhoverlink: function(e) {
            if (this.dataRangeOption.show && this.dataRangeOption.hoverLink && this._indicatorShape && e && null != e.seriesIndex && null != e.dataIndex) {
                var t = e.value;
                if ("" === t || isNaN(t)) return;
                t < this.dataRangeOption.min ? t = this.dataRangeOption.min: t > this.dataRangeOption.max && (t = this.dataRangeOption.max),
        ...
        _buildColorList: function(e) {
            if (this._colorList = m.getGradientColors(this.dataRangeOption.color, Math.max((e - this.dataRangeOption.color.length) / (this.dataRangeOption.color.length - 1), 0) + 1), this._colorList.length > e) {
                for (var t = this._colorList.length,
                i = [this._colorList[0]], n = t / (e - 1), a = 1; e - 1 > a; a++) i.push(this._colorList[Math.floor(a * n)]);
                i.push(this._colorList[t - 1]),
                this._colorList = i
            }
            if (this._useCustomizedSplit()) for (var o = this._splitList,
            a = 0,
            t = o.length; t > a; a++) o[a].color && (this._colorList[a] = o[a].color)
        },
        _buildGap: function(e) {
            if (!this._useCustomizedSplit()) {
                ...
                this.dataRangeOption.precision = t,
                this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / e).toFixed(t) - 0
            }
        },
        ...
        _buildSplitList: function() {
            if (this._useCustomizedSplit()) for (var e = this.dataRangeOption.splitList,
            t = this._splitList = [], i = 0, n = e.length; n > i; i++) {
                var a = e[i];
                ...
                o.min = a.start,
                o.max = a.end,
                o.min > o.max && (o.min = [o.max, o.max = o.min][0]),
                o.min === o.max && (o.single = o.max),
                null == o.min && (o.min = -Number.MAX_VALUE),
                null == o.max && (o.max = Number.MAX_VALUE),
                t.push(o)
            }
        },
        refresh: function(e) {
        ...
        getColor: function(e) {
            ...
            var t;
            if (this._useCustomizedSplit()) {
                for (var i = this._splitList,
                n = 0,
                a = i.length; a > n; n++) if (i[n].min <= e && i[n].max >= e) {
                    t = n;
                    break
                }
            } else {
                ...
                t = this._colorList.length - Math.ceil((e - this.dataRangeOption.min) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._colorList.length),
...
function(e) {
    function t(e, t, n, a, o) {
        if (this.rcOption = {},
        a.roamController && a.roamController.show) {
    ...
    return e.prototype = {
        getCanvas: function(e, t, a) {
            ...
            for (var y = h.getImageData(0, 0, l.width, l.height), g = y.data, m = g.length / 4; m--;) {
                ...
                g[b - 2] = r[4 * f + 1],
                g[b - 1] = r[4 * f + 2],
                g[b] *= this.option.opacity
            }
            return h.putImageData(y, 0, 0),
            l
        },
        _getBrush: function() {
...
function(e) {
    function t(e) {
        ...
        n = 0; n < t.length; n++) for (var a = t[n], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; s < o.length; s++) {
            var l = o[s];
            if ("Polygon" === a.geometry.type) o[s] = i(l, r[s]);
            else if ("MultiPolygon" === a.geometry.type) for (var h = 0; h < l.length; h++) {
                var m = l[h];
                l[h] = i(m, r[s][h])
            }
        }
        ...
        "南海诸岛": {
            ...
            getPath: function(e, t) {
                for (var i = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], n = "", a = e[0], o = e[1], r = 0, s = i.length; s > r; r++) {
                    ...
                    for (var l = 1,
                    h = i[r].length; h > l; l++) n += "L " + ((i[r][l][0] * t + a).toFixed(2) - 0) + " " + ((i[r][l][1] * t + o).toFixed(2) - 0) + " "
                }
                return n + " Z"
            }
        },
...
function(e) {
    ...
    function s(e, t) {
        ...
        i && "none" != i ? (e.color = i, n ? (e.brushType = "both", e.strokeColor = n) : e.brushType = "fill") : n && "none" != n && (e.strokeColor = n, e.brushType = "stroke"),
        ...
        polygon: function(e, t) {
            ...
            if (i) {
                ...
                for (var o = 0; o < i.length; o++) {
                    var r = i[o];
                    n[0] = Math.min(r[0], n[0]),
                    n[1] = Math.min(r[1], n[1]),
...
function() {
    ...
    function t(e, t) {
        ...
        r.ymin = 180,
        r.ymax = -180;
        for (var i, n, a = e.features,
        o = 0,
        s = a.length; s > o; o++) if (n = a[o], !n.properties.name || !t[n.properties.name]) switch (n.type) {
        case "Feature":
        ...
        case "GeometryCollection":
            i = n.geometries;
            for (var l = 0,
            h = i.length; h > l; l++) r[i[l].type](i[l].coordinates)
        }
        return e.srcSize = {
    ...
    function i(e, i, n) {
        ...
        m = [], V = 0, U = h.length; U > V; V++) if (l = h[V], !l.properties.name || !n[l.properties.name]) if ("Feature" == l.type) a(l.geometry, l);
    ...
    function n(e, t) {
        var i, n;
        return t instanceof Array ? (i = 1 * t[0], n = 1 * t[1]) : (i = 1 * t.x, n = 1 * t.y),
        i = i / e.scale.x + e.offset.x - 168.5,
        i = i > 180 ? i - 360 : i,
        n = 90 - (n / e.scale.y + e.offset.y),
        [i, n]
    }
    function a(e, t) {
        return o.offset = e.offset,
        o.scale = e.scale,
        o.makePoint(t instanceof Array ? [1 * t[0], 1 * t[1]] : [1 * t.x, 1 * t.y])
    }
    var o = {
        ...
        LineString: function(e) {
            for (var t, i = "",
            n = 0,
            a = e.length; a > n; n++) t = o.makePoint(e[n]),
            i = 0 === n ? "M" + t.join(",") : i + "L" + t.join(",");
            return i
        },
        Polygon: function(e) {
            for (var t = "",
            i = 0,
            n = e.length; n > i; i++) t = t + o.LineString(e[i]) + "z";
            return t
        },
        ...
        MultiLineString: function(e) {
            for (var t = "",
            i = 0,
            n = e.length; n > i; i++) t += o.LineString(e[i]);
            return t
        },
        MultiPolygon: function(e) {
            for (var t = "",
            i = 0,
            n = e.length; n > i; i++) t += o.Polygon(e[i]);
            return t
        }
    },
    r = {
        ...
        LineString: function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) this.makePoint(e[t])
        },
        Polygon: function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) this.LineString(e[t])
        },
        MultiPoint: function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) this.Point(e[t])
        },
        MultiLineString: function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) this.LineString(e[t])
        ...
        MultiPolygon: function(e) {
            for (var t = 0,
            i = e.length; i > t; t++) this.Polygon(e[t])
        }
    };
    return {
        getBbox: e,
