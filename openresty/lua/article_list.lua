...
function _M.index()
	...
	local result ={blogArticleTimes=blogArticleTime,blogArticleLables=blogArticleLable,hotBlogArticles=hotBlogArticle,classifys=classify,is_this_index=is_this_index,recentUsers=recentUser}
   -- 1、外部模板文件
